...
from wtforms import widgets, SelectMultipleField, RadioField, Label
...
class FilterForm(FlaskForm):
  ...
  uni_data = MultiCheckboxField('Universities', choices=uni)
  subject_data = MultiCheckboxField('Subjects', choices=subject)
  
  radio = RadioField('Order By', choices=[('alphabet','A-Z'),('likes','Likes')], default='alphabet')